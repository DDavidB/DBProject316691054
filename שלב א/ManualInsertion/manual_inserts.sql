-- 1. Inserting data into Patients table (using JSON and dates)
...
-- 2. Inserting data into Doctors table (including working hours in JSON)
...
-- 4. Inserting data into Visits Records table (including vitals in JSON)
...
-- 6. Inserting data into Payments table (including transaction details in JSON)
